...
export default function ProductEdit() {
  const { setisHeaderSidebar,setAlertBox, setProgress, BaseURl } = useContext(UserContext);
        ...
        <div className="row">
             <div className="col-sm-12">
              <div className="card p-4 ">
                 ...
                 <br/>
                  <Button variant="contained" color="warning" className="w-100" onClick={editProduct} > <FaCloudUploadAlt className="mx-1 h4 mb-0"/>  {isloading === true ? <CircularProgress color="inherit" className="loader mx-3" />: 'Publish and View'}  </Button>
                 </div>
              </div>
             </div>
          </div>
